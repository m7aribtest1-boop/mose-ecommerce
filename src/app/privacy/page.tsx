      ...
      <section className="py-12 bg-secondary-50">
        <div className="container-custom max-w-3xl">
          <div className="card p-6 space-y-4 text-sm text-secondary-700">
            ...
            <p>عند إتمام طلب نلتقط: الاسم الكامل، رقم الهاتف، البريد الإلكتروني (اختياري)، المدينة والعنوان (اختياري). لا نجمع أبداً بيانات بطاقتك البنكية — هذه تعالج مباشرة عبر مزود الدفع الآمن (CMI).</p>
